...
particionar( dataset, division=c(50,50), agrupa="clase_ternaria", seed=   777859 )  #Cambiar por la primer semilla de cada uno !
...
# 70/30 9306667, 8500000, 11753333, 10703333, 7620000, 8300000
# 50/50 9214000, 9384000, 8484000, 10286000, 7566000, 7802000