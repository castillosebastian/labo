...
param_basicos  <- list( "cp"=          -0.41853818,  #complejidad minima
                        "minsplit"=   1458,     #minima cantidad de registros en un nodo para hacer el split
                        "minbucket"=  365,     #minima cantidad de registros en una hoja
...
fwrite( entrega, 
        file= "~/R/labo/exp/KA2022/K242_001.csv", 
        sep= "," )
