...
ksemillas  <- c(777781, 777787, 777817, 777839, 777857, 777859) #reemplazar por las propias semillas
...
# Meter en bucles anidados
# minbuket tiene que tener relacion con minsplit
# Salida
# cat( )

for (param_basicos$minsplit in c(1,2,3,4)){
  
  for (param_basicos$minbucket in c(1,2,3,)){
