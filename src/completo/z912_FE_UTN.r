...
AgregarVariables  <- function( dataset )
{
  ...
  # mia
  dataset[  , mpayroll_sobre_antiguedad  := mpayroll / cliente_antiguedad ]
  dataset[  , mpayroll_sobre_ctrx_q  := mpayroll / ctrx_quarter_normalizado ]
  dataset[  , mpayroll_por_antiguedad  := mpayroll * cliente_antiguedad ]
  dataset[  , mpayroll_sobre_ctrx_q  := mpayroll * ctrx_quarter_normalizado ]
