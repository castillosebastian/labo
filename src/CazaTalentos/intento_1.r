...
Estrategia_A  <- function(tirosr1, tirosr2, tirosr3)
{
  #Estrategia
  ...
  #Ronda 2 : LA MITAD MEJOR DE R1: TODOS CONTRA TODAS
  ...
  planilla_cazatalentos[ ids_juegan2,  tiros2 := tirosr2 ]  #registro en la planilla que tiran 400 tiros
  #Hago que tiren
  resultado2  <- gimnasio_tirar( ids_juegan2, tirosr2)
  #Registro
  planilla_cazatalentos[ ids_juegan2,  aciertos2 := resultado2 ]  #registro en la planilla
  
  #Ronda 3 : LA MITAD MEJOR DE R2: TODOS CONTRA TODAS
  ...
  # Preparo ronda
  planilla_cazatalentos[ ids_juegan3,  tiros3 := tirosr3 ]  #registro en la planilla que tiran 400 tiros
  #Hago que tiren
  resultado3  <- gimnasio_tirar( ids_juegan3, tirosr3)
  #Registro
...
for(tirosr1 in seq_along(1:10)){
  for(tirosr2 in seq_along(1:300)){
    for(tirosr3 in seq_along(1:200)){
      
      #notar como se agrega
      param_basicos  <- list( "tiros1"= tirosr1,      
                              "tiros2"= tirosr2,  
                              "tiros3"= tirosr3) 
      
      #Un solo llamado, con la semilla 17
      resultado  <- Estrategia_A(tirosr1, tirosr2, tirosr3)
      
      #escribo los resultados al archivo de salida FALATA RESOLVER!
