...
Estrategia_A  <- function()
{
  ...
  planilla_cazatalentos[ ids_juegan1,  tiros1 := 20 ]  #registro en la planilla que tiran 90 tiros

  #Hago que tiren
  resultado1  <- gimnasio_tirar( ids_juegan1, 20)
  
  resultado1 = fixed_random(20, resultado1)
  ...
  planilla_cazatalentos[ ids_juegan2,  tiros2 := 100 ]  #registro en la planilla que tiran 400 tiros
  resultado2  <- gimnasio_tirar( ids_juegan2, 100)
  
  resultado2 = fixed_random(100, resultado2)
