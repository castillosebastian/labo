...
Estrategia_A  <- function()
{
  ...
  # cuartiles  <- planilla_cazatalentos[ ids_juegan1, quantile(aciertos1) ]
  # cuartil3 = cuartiles[[4]]
  # ids_juegan2  <- planilla_cazatalentos[ ids_juegan1 ][ aciertos1 >= cuartil3, id ]
