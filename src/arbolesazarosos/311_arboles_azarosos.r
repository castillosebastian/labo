...
dir.create( "~/R/labo/exp/KA2101/", showWarnings = FALSE )

#aqui es donde voy a graficar los arboles
pdf( "~/R/labo/exp/KA2101/arbolitos.pdf", paper="a4r" )
...
fwrite( tb_ensembles,
        file="~/R/labo/exp/KA2101/ensemble.csv",
        sep="\t" )
...
fwrite( entrega, 
        file= "~/R/labo/exp/KA2101/K311_001.csv", 
        sep= "," )
