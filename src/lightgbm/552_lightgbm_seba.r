...
modelo  <- lgb.train( data= dtrain,
                      param= list( objective=        "binary",
                                   ...
                                   seed=               777781   #aqui se utiliza SU primer semilla
                                  )
                    )
...
dir.create( "~/R/labo/exp/KA5520_v2/", showWarnings = FALSE )
setwd( "~/R/labo/exp/KA5520_v2/" )

archivo_salida  <- "KA_552_001_v2.csv"
